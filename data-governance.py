...
scheme_df = pd.read_csv('data-governance-rdfs-scheme.csv', index_col = '@id', keep_default_na = True)
scheme = rdfpandas.to_graph(scheme_df, namespace_manager)
